...
class EcoFlowAPI:
    ...
    def set_backup_reserve(self, enabled: bool) -> bool:
        """Enable or disable backup reserve."""
        params = {
            "sn": self.device_sn,
            "cmdCode": "WN511_SET_BACKUP_RESERVE",
            "params": {
                "isConfig": 1 if enabled else 0,
                "bpPowerSoc": 50,  # Default to 50% when enabling
                "minDsgSoc": 0,
                "minChgSoc": 0
            }
        }
    ...
    def set_solar_priority(self, enabled: bool) -> bool:
        """Enable or disable solar charging priority."""
        params = {
            "sn": self.device_sn,
            "cmdCode": "WN511_SET_SOLAR_PRIORITY",
            "params": {
                "pvChangeSet": 1 if enabled else 0
            }
        }
    ...
    def set_ac_always_on(self, enabled: bool) -> bool:
        """Enable or disable AC always on."""
        params = {
            "sn": self.device_sn,
            "cmdCode": "WN511_SET_AC_ALWAYS_ON",
            "params": {
                "acAutoOutConfig": 1 if enabled else 0,
                "minAcOutSoc": 5  # Minimum 5% to keep AC on
            }
        }
    ...
    def set_backup_reserve_level(self, level: int) -> bool:
        """Set backup reserve level (5-100%)."""
        params = {
            "sn": self.device_sn,
            "cmdCode": "WN511_SET_BACKUP_RESERVE",
            "params": {
    ...
    def set_generator_auto_start(self, level: int) -> bool:
        """Set generator auto start level (0-30%)."""
        params = {
            "sn": self.device_sn,
            "cmdCode": "WN511_SET_GENERATOR_AUTO_START",
            "params": {
                "openOilSoc": level
            }
        }
    ...
    def set_generator_auto_stop(self, level: int) -> bool:
        """Set generator auto stop level (50-100%)."""
        params = {
            "sn": self.device_sn,
            "cmdCode": "WN511_SET_GENERATOR_AUTO_STOP",
            "params": {
                "closeOilSoc": level
            }
        }
